...
export class QwenConfigurator extends EditorConfigurator {
  ...
  async isAvailable(_projectPath: string): Promise<boolean> {
    // Qwen Code is always available as a supported editor
    return true;
  }
  ...
  async configure(options: ConfigureOptions): Promise<ConfigureResult> {
    ...
    try {
      ...
      // Create dash-prefixed symlinks for Qwen Code
